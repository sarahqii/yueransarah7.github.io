...
exports.projects = [
    ...
    {
        title: react_1.default.createElement(react_1.default.Fragment, null, react_1.default.createElement('a', {
            href: 'https://madcamp.io/',
            className: 'text-blue-600 hover:underline',
            target: '_blank',
            rel: 'noopener noreferrer'
        }, 'Mad Camp'), ': Hackaton Program for Intensive Programming and Startup'),
